        ...
        <div className='container mx-auto'>
            ...
            <div className="flex justify-center mobile-S-Laptop:flex-wrap mt-[3rem]">
                <div> 
                    ...
                    <h1 className='text-2xl text-center font-bold'>Social Transactions</h1>
                ...
                <div> 
                    ...
                    <h1 className='text-2xl text-center font-bold'>Direct Payments</h1>
                ...
                <div> 
                    ...
                    <h1 className='text-2xl text-center font-bold'>Marketplace Transactions</h1>
